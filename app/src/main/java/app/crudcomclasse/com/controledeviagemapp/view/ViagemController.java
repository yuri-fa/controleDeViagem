...
//        String query = "SELECT MAX(vinumsequencial) FROM viagem";
//        Cursor curso = db.rawQuery(query,null);
//        if (curso.moveToFirst()){
//            idViagem = Integer.parseInt(curso.getString(curso.getColumnIndex("vinumsequencial")));
//        }
        return valido;
    }
