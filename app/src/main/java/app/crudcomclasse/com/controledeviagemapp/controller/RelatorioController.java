            ...
            do{
                ...
                if (cursorPlaca.moveToFirst()){
                    do{
                        ...
                        BigDecimal peso = new BigDecimal(cursor.getString(cursor.getColumnIndex("plapeso")));
                        String serial = cursor.getString(cursor.getColumnIndex("plaserial"));
                        Integer plaNumSequencial = Integer.parseInt(cursor.getString(cursor.getColumnIndex("planumsequencial")));
